...
fest_managed: true
fest_created: 2026-06-12T00:56:20.207972-06:00
fest_updated: 2026-06-14T21:34:08.248384-06:00
fest_tracking: true
fest_version: "1.0"
---
...
```bash
just build stable
# PASS: 96 packages, build successful, total time 22.15s

just build dev
# PASS: 98 packages, build successful, total time 22.00s

just test unit
# PASS: 79 packages, 2537/2537 tests passed, total time 29.50s

BUILD_TAGS=dev just test unit
# PASS: 81 packages, 2557/2557 tests passed, total time 30.26s
...
Integration coverage for the container-touched work in this sequence was verified immediately before this gate:

```bash
just test integration
# PASS: 1 suite, 367/367 tests passed, total time 179.01s

just test integration
# PASS: 1 suite, 367/367 tests passed, total time 174.43s
```