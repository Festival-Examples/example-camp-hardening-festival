...
5. Verify tests that create, copy, move, delete, chmod, git-init, or otherwise mutate real filesystem state run in a containerized integration harness, not host-side unit tests
